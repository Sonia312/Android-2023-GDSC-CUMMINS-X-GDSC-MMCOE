...
public class Ex_auto_que1 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (!ratingString.isEmpty()) {
                    ...
                    if (rating >= 1 && rating <= 10) {
                        Intent intent = new Intent(Ex_auto_que1.this, Ex_auto_que2.class);
                        startActivity(intent);
                    } else {
                        // Show an error message if the rating is out of range
                        Toast.makeText(Ex_auto_que1.this, "Please rate from 1 to 10", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // Show an error message if the EditText is empty
                    Toast.makeText(Ex_auto_que1.this, "Please enter a rating", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
