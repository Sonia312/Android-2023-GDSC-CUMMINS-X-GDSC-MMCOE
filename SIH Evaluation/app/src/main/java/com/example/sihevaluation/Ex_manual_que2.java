...
public class Ex_manual_que2 extends AppCompatActivity {
  private EditText ratingEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ext_man_que2);
            ...
            public void onClick(View v) {
                ...
                if (!ratingString.isEmpty()) {
                    ...
                    if (rating >= 1 && rating <= 10) {
                        Intent intent = new Intent(Ex_manual_que2.this, Ex_manual_que3.class);
                        startActivity(intent);
                    } else {
                        // Show an error message if the rating is out of range
                        Toast.makeText(Ex_manual_que2.this, "Please rate from 1 to 10", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // Show an error message if the EditText is empty
                    Toast.makeText(Ex_manual_que2.this, "Please enter a rating", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
